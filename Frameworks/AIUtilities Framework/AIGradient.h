 ...
 *
 * Cocoa wrapper around lower level gradient drawing functions.  Draws simple gradients.  Methods are self-explanatory; <tt>direction</tt> is one of AIHorizontal or AIVertical.
 */
