...
@abstract Class to notify when the system goes to sleep and wakes from sleep and optionally place a hold on the sleep process.
@discussion <p><tt>AISleepNotification</tt> posts (on the default NSNotificationCenter) <tt>AISystemWillSleep_Notification</tt> when the system is about to go to sleep, and posts <tt>AISystemDidWake_Notification</tt> when it wakes from sleep.</p>
