 ...
 *
 *	@param	The amount (greater than 0.0 and at most 1.0) to subtract from the receiver's brightness.
 ...
 *
 *	@param	The amount (greater than 0.0 and at most 1.0) to subtract from the receiver's brightness and add to the receiver's saturation.
