/*!
	...
	@brief Header file for <tt>NDComponentInstance</tt>.
...
/*!
	...
	@brief A class to represent a component instance.
...
/*!
	...
	@brief Returns the shared component instance.
...
/*!
	...
	@brief Close the shared component instance.
...
/*!
	...
	@brief Finds the next OSA component.
...
/*!
	...
	@brief Allocates and initializes a <tt>NDComponentInstance</tt>
...
/*!
	@method init
	@brief Intializes a <tt>NDComponentInstance</tt>.
...
/*!
	...
	@brief Intialize a <tt>NDComponentInstance</tt>.
...
/*!
	...
	@brief  sets the default target, specified by creator code, for any AppleEvents
...
/*!
	...
	@brief  sets the object that any handles any AppleEvent the script atempts to send.
...
/*!
	...
	@brief returns the object that handles any AppleEvents
...
/*!
	...
	@brief sets the object which is periodicly sent the message <tt>appleScriptActive:</tt>.
...
/*!
	@method activeTarget
	@brief returns the active target as set by the method <tt>setActiveTarget:</tt>
