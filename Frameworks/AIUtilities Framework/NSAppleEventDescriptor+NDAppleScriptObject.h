/*!
	...
	@brief Declares the category <tt>NSAppleEventDescriptor (NDAppleScriptObject)</tt>
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> for the <tt>AEDesc</tt>.
...
/*!
	...
	@brief Intializes a <tt>NSAppleEventDescriptor</tt> with a <tt>AEDesc</tt>.
...
/*!
	...
	@brief Determines if target is current process.
...
/*!
	@method getAEDesc:
	@brief Get the receviers <tt>AEDesc</tt>.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> for the current process.
...
/*!
	...
	@brief Returns the receviers target ProcessSerialNumber.
...
/*!
	...
	@brief Returns the receviers target Creator.
...
/*!
	...
	@brief Returns an list descriptor of alias descriptors.
...
/*!
	...
	@brief Returns a url descriptor.
...
/*!
	...
	@brief Returns a alias descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a true boolean descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a false boolean descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a short integer descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a long integer descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a integer descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a float descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a double descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a unsigned integer descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a string the c string..
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a number descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> containing a value descriptor.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt>.
...
/*!
	...
	@brief Returns a list descriptor.
...
/*!
	...
	@brief Returns a record descriptor
...
+ (NSAppleEventDescriptor *)userRecordDescriptorWithObjects:(id *)objects keys:(NSString **)keys count:(unsigned int)count;
	...
	@brief Returns a user record descriptor.
	 @discussion Create a list descriptor that can be used as the value for the key <tt>keyASUserRecordFields</tt> in record descriptors of AppleEvents representing AppleScript subroutine calls, this is how records in AppleScripts represented. The objects are converted to <tt>NSAppleEventDescriptor</tt> using the method <tt>descriptorWithObject:</tt>.
...
/*!
	@method arrayValue
	@brief Returns an <tt>NSArray</tt> for a list descriptor.
...
/*!
	...
	@brief Returns an <tt>NSDictionary</tt> for a record descriptor.
...
/*!
	@method urlValue
	@brief Returns a <tt>NSURL</tt> for the recevier..
...
/*!
	...
	@brief Returns a unsigned int value for the recevier.
...
/*!
	@method floatValue
	@brief Returns a float value for the recevier.
...
/*!
	@method doubleValue
	@brief Returns a double value for the recevier.
...
/*!
	@method value
	@brief Returns a <tt>NSValue</tt> object for the recevier.
...
/*!
	@method numberValue
	@brief Returns a <tt>NSNumber</tt> object for the recevier.
...
/*!
	@method objectValue
	@brief Returns a object for the recevier.
...
@interface NSAppleEventDescriptor (NDCompleteEvents)
	...
	@brief Get a <tt>NSAppleEventDescriptor</tt> for an open event.
...
/*!
	...
	@brief Get a <tt>NSAppleEventDescriptor</tt> for a quit event.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> for calling AppleScript routines.
...
/*!
	@method descriptorWithSubroutineName:argumentsArray:
	 @brief Returns a <tt>NSAppleEventDescriptor</tt> for calling an AppleScript subroutine with positional arguments.
...
/*!
	...
	@brief Returns a <tt>NSAppleEventDescriptor</tt> for calling an AppleScript routine with labeled arguments.
...
/*!
	...
	@brief Initialises a <tt>NSAppleEventDescriptor</tt> for calling AppleScript routines.
