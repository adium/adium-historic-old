 ...
 * @brief Header file for <tt>NDAppleScriptObject</tt>.
 *
* <tt>NDAppleScriptObject</tt> is used to represent compiled AppleScripts within Cocoa. The only restriction for use of this code is that you keep the comments with the head files especially my name. Use of this code is at your own risk yada yada yada...
 */
 ...
 * @brief Class to represent an AppleScript.
 *
* As well as representing an AppleScript, <tt>NDAppleScriptObject</tt> also can maintain separate context for each AppleScript, useful if you want to run each script within a seperate thread. <tt>NDAppleScriptObject</tt> is interface compatible with <tt>NSAppleScript</tt>
  */
 ...
 * @brief Compiles and executes the AppleScript within the passed string.
 *
* Executes the script by calling it&rsquo;s run handler.
	@param string  A string that contains the AppleScript source to be compiled and executed.
 * @return  Returns the result of executing the AppleScript as a Objective-C object, see <tt> objectValue:</tt> for more details.
 */
 ...
 * @return  Returns the result of executing the AppleScript as a Objective-C object. See <tt>resultObject</tt> for more details.
 */
 ...
 * @brief Returns an <tt>NDAppleScriptObject</tt> compiled from passed string.
 *
* An autoreleasing version of <tt>initWithString:</tt> with mode flags set to <tt>kOSAModeCompileIntoContext</tt>.
	@param string  A string that contains the AppleScript source to be compiled.
 * @return  Returns the <tt>NDAppleScriptObject</tt> instance.
 */
 ...
 * @brief Returns an <tt>NDAppleScriptObject</tt> from the <tt>NSData</tt> containing a compiled AppleScript.
 *
* An autoreleasing version of <tt>initWithData:</tt>.
	@param string  A string that contains the AppleScript source to be compiled.
 * @return  Returns the <tt>NDAppleScriptObject</tt> instance.
 */
 ...
 * @brief Returns an <tt>NDAppleScriptObject</tt> from the <tt>NSData</tt> containing a compiled AppleScript.
 *
* An autoreleasing version of initWithData:.
	@param string  A string that contains the AppleScript source to be compiled.
	@param componentInstance The <tt>NDComponentInstance</tt> to use the AppleScript with.
 * @return  Returns the <tt>NDAppleScriptObject</tt> instance.
 */
 ...
 * @brief Returns an <tt>NDAppleScriptObject</tt> by reading in the compiled AppleScript at passed path.
 *
* An autoreleasing version of initWithContentsOfFile:.
 ...
 * @brief Returns an <tt>NDAppleScriptObject</tt> by reading in the compiled AppleScript at passed file URL.
 *
* An autoreleasing version of initWithContentsOfURL:.
 ...
 * @brief Returns an <tt>NDAppleScriptObject</tt> compiled from passed string.
 *
* initWithString:modeFlags: with the default component and mode flags of <tt>kOSAModeCompileIntoContext</tt>.
	@param string  A string that contains the AppleScript source to be compiled.
 * @return  Returns the <tt>NDAppleScriptObject</tt> instance.
  */
 ...
 * @brief Returns an <tt>NDAppleScriptObject</tt> compiled from passed string.
 *
* initWithString:modeFlags: with the default component.
	@param string  A string that contains the AppleScript source to be compiled.
 ...
 * @brief Initialises receiver with a compiled AppleScript file.
 *
* Initialize the receiver with the compiled AppleScript file at the supplied path, the compiled AppleScript can be in either the resource fork or the data fork. If the file is not complied and is instead a AppleScript as text then you must read in the text of the file and pass it to <tt>initWithString:modeFlags:</tt>. 
	@param path The path for the compiled AppleScript file.
 * @return An initialized <tt>NDAppleScriptObject</tt>
   */
 ...
 * @brief Initialises receiver with a compiled AppleScript file.
 *
* Initialize the receiver with the compiled AppleScript file at the supplied path and a <tt>NDComponentInstance</tt> as returned from the method <tt>+[NDComponentInstance findNextComponent]</tt>, the compiled AppleScript can be in either the resource fork or the data fork.  If the file is not complied and is instead a AppleScript as text then you must read in the text of the file and pass it to <tt>initWithString:modeFlags:</tt>. 
	@param path The path for the compiled AppleScript file.
	@param componentInstance The <tt>NDComponentInstance</tt> to use the AppleScript with.
 * @return An initialized <tt>NDAppleScriptObject</tt>
  */
 ...
 * @brief Initialises receiver with a compiled AppleScript file.
 *
* Initialize the receiver with the compiled AppleScript file at the supplied file URL, the compiled AppleScript can be in either the resource fork or the data fork. If the file is not complied and is instead a AppleScript as text then use the <tt>initWithString:modeFlags:</tt> method instead obtaining the string with the method<tt>-[NSString initWithURL:]</tt>.
 ...
 * @brief Initialises receiver with a compiled AppleScript file.
 *
* Initialize the receiver with the compiled AppleScript file at the supplied file URL and a <tt>NDComponentInstance</tt> as returned from the method <tt>+[NDComponentInstance findNextComponent]</tt>, the compiled AppleScript can be in either the resource fork or the data fork. If the file is not complied and is instead a AppleScript as text then use the <tt>initWithString:modeFlags:</tt> method instead obtaining the string with the method<tt>-[NSString initWithURL:]</tt>.
	@param URL The file URL for the compiled AppleScript file.
	@param componentInstance The <tt>NDComponentInstance</tt> to use the AppleScript with.
 * @return An initialized <tt>NDAppleScriptObject</tt>
  */
...
/*!
	@method initWithData:
 * @brief Initialises receiver with compiled AppleScript data.
 *
* Initialize the with a <tt>NSData</tt> object containing the data for an compiled AppleScript.
 ...
 * @brief Returns an <tt>NDAppleScriptObject</tt> compiled from passed string.
 *
* Initialzes the recieve by compiling the recieved source, if compilation failes then the error can be returned with the method <tt>error</tt> and the method <tt>isCompiled</tt> returns false.
	@param URL  A file URL to the compiled AppleScript file.
 * @return  Returns the <tt>NDAppleScriptObject</tt> instance.
  */
 ...
 * @brief Initialises receiver with compiled AppleScript data.
 *
* Initialize the with a <tt>NSData</tt> object containing the data for an compiled AppleScript and a <tt>NDComponentInstance</tt> as returned from the method <tt>+[NDComponentInstance findNextComponent]</tt>.
	@param data A <tt>NSData</tt> object containing the compiled AppleScript.
	@param componentInstance The <tt>NDComponentInstance</tt> to use the AppleScript with.
 * @return An initialized <tt>NDAppleScriptObject</tt>
  */
...
/*!
	@method data
 * @brief Returns the compiled script within a <tt>NSData</tt> instance.
 *
* The returned <tt>NSData</tt> instance contains a compiled script which can be
				passed to the <tt>initWithData:component:</tt> method.
 * @return  Returns an <tt>NSData</tt> instance.
  */
- (NSData *)data;
 ...
 *
* Executes the script.
 * @return  Returns <tt>YES</tt> if execution was successful.
  */
- (BOOL)execute;

/*!
	@method executeOpen
 * @brief Sends an open event.
 *
* Executes the script by calling its open handler passing an alias list creaed from parameters.
...
/*!
	@method executeEvent:
 * @brief Execute an AppleEvent.
 *
* Sends an AppleEvent to the script.
 ...
 * @brief Execute an AppleScript function.
 *
* Executes the AppleScript subroutine <tt><i>name</i></tt> passing the objects within <tt>array</tt> as positional arguments after being converted to <tt>NSAppleEventDescriptor</tt>s with the method <tt>-[NSAppleEventDescriptor descriptorWithObject:]</tt>.
 ...
 * @brief Execute an AppleScript function.
 *
* Executes the AppleScript subroutine <tt><i>name</i></tt> passing the objects starting with <tt><i>firstObject</i></tt> as positional arguments after being converted to <tt>NSAppleEventDescriptor</tt>s with the method <tt>-[NSAppleEventDescriptor descriptorWithObject:]</tt>.
	@param name The function name, this is case insensitive.
 ...
 * @brief Returns all event identifiers the script responds to.
 *
* Returns an <tt>NSArray</tt> of <tt>NSDictionary</tt>s with the keys "<tt>EventClass</tt>" and "<tt>EventID</tt>".
 * @return  Returns an <tt>NSArray</tt> of event identifier <tt>NSDictionary</tt>s.
  */
- (NSArray *)arrayOfEventIdentifier;

/*!
	@method respondsToEventClass:eventID:
 * @brief Tests whether the script responds to an AppleEvent.
 *
* This method test whether the script responds to the passed event identifier.
	@param eventClass  The event class.
	@param eventID  The event identifier.
 * @return  Returns true if the script reponds to the event identifier.
  */
- (BOOL)respondsToEventClass:(AEEventClass)eventClass eventID:(AEEventID)eventID;

/*!
	@method respondsToSubroutine:
 * @brief Tests whether the script responds to a subroutine call.
 *
* This method test whether the script inplements the subroutine <tt><i>name</i></tt>, subroutine names are case insensitive and so the string <tt><i>name</i></tt> is converted to lower case first.
	@param name The subroutine name.
 * @return  Returns true if the script reponds to the subroutine call.
  */
- (BOOL)respondsToSubroutine:(NSString *)name;

/*!
	@method arrayOfPropertyNames
 * @brief Get array of property names.
 *
* Returns an array of string for every property contained within the receiver.
 * @return An <tt>NSArray</tt> of <tt>NSStrings</tt>
  */
 ...
 * @brief Sets the value of a script property.
 *
* Sets the value of a script property within the recievers script.
 ...
 * @return Return <tt>YES</tt> if successful.
  */
 ...
 * @brief Returns the result as an AppleEvent type..
 *
* Returns the result of the last script execution as an AppleEvent type within an <tt>NSAppleEventDescriptor</tt>.
 * @return  The <tt>NSAppleEventDescriptor</tt> contains the AppleEvent type result.
  */
- (NSAppleEventDescriptor *)resultAppleEventDescriptor;

/*!
	@method resultObject
 * @brief Returns the result as an Objective-C object.
 *
* Converts the AppleEvent type returned from the last script execution into an
 ...
 * @return  A subclass of <tt>NSObject</tt>.
  */
- (id)resultObject;

/*!
	@method resultData
 * @brief Returns the result as an <tt>NSData</tt> instance.
 *
* Returns the raw bytes from the result AppleEvent type.
 ...
 * @brief Returns the result as an OSA formatted string.
 *
* Returns the result as a string by calling OSA&rsquo;s <tt>OSADisplay</tt> function. The result is
				in the same format as seen in Script Editor&rsquo;s result window.
 * @return  The <tt>NSString</tt> result.
  */
- (NSString *)resultAsString;

/*!
	@method componentInstance
 * @brief Get the component instance.
 *
* The <tt>NDComponentInstance</tt> represents the connection to the OSA component.
 * @return A <tt>NDComponentInstance</tt>
   */
- (NDComponentInstance *)componentInstance;
/*!
	@method executionModeFlags
 * @brief Returns the execution mode flags.
 *
* The flags are eqivelent to AESend flags.
	<blockquote><blockquote>
		<table border="1"  width="90%">
 ...
 * @return  A long int containing the execution mode flag bits.
  */
- (long)executionModeFlags;
/*!
	@method setExecutionModeFlags:
 * @brief Sets the execution mode flags.
 *
* The flags are equivalent to AESend flags.
	<blockquote><blockquote>
	<table border="1"  width="90%">
		<thead><tr><th>Flag</th><th>Description</th></tr></thead>
			<tr>
 ...
 * @return A <tt>NSDictionary</tt>  containing error information
  */
- (NSDictionary *)error;

/*!
	@method compile
 * @brief Compile a AppleScript with default mode flags.
 *
* Compiles the receiver with a mode flag of <tt>kOSAModeCompileIntoContext</tt>, if it is not already compiled. Returns <tt>YES</tt> for success or if the script was already compiled, <tt>NO</tt> otherwise. Currently <tt>NDAppleScriptObject</tt> compiles scripts at initialization and will only not be compiled if compilation failed.
 * @return Returns <tt>YES</tt> if successful.
  */
- (BOOL)compile;

/*!
	@method compileWithModeFlags:
 * @brief Compile a AppleScript.
 *
* Compiles the receiver with the supplied mode flags, if it is not already compiled. Returns <tt>YES</tt> for success or if the script was already compiled, <tt>NO</tt> otherwise. Currently <tt>NDAppleScriptObject</tt> compiles scripts at initialization and will only not be compiled if compilation faile.
	@param modeFlags  Mode flags passed to OSACompile (see Apple OSA documentation).
 * @return Returns <tt>YES</tt> if successful.
  */
...
/*!
	@method isCompiled
 * @brief Is the AppleScript compiled.
 *
* Returns YES if the receiver is already compiled, NO otherwise. Currently <tt>NDAppleScriptObject</tt> compiles scripts at initialization and will only not be compiled if compilation faile
 * @return Returns <tt>YES</tt> if the receiver is compiled.
  */
- (BOOL)isCompiled;

	/*!
	@method source
 * @brief Get the AppleScript source
 *
* Returns the source code of the receiver if it is available, nil otherwise. It is possible for an <tt>NDAppleScriptObject</tt> to be a script for which the source code is not available but is nonetheless executable (a read-only script).

 * @return A <tt>NSString</tt>
  */
- (NSString *)source;

/*!
	@method writeToURL:
 * @brief Writes the receiver as a complied AppleScript.
 *
* The compiled script is written to the <tt>'scpt'</tt> resource, id <tt>128</tt> of the resource fork of the file.
	@param URL  A file URL for the compiled AppleScript file.
 * @return Returns <tt>YES</tt> if writing succeeded.
  */
 ...
 * @return Return <tt>YES</tt> if writing succeeded.
  */
 ...
 * @brief Writes the receiver as a complied AppleScript.
 *
* The compiled script is written to the <tt>'scpt'</tt> resource, with the passed id of the resource fork of the file.
	@param URL  A file URL for the compiled AppleScript file.
 ...
 * @brief Category of <tt>NSAppleEventDescriptor</tt>.
 *
* Adds a method to <tt>NSAppleEventDescriptor</tt> to retrieve a <tt>NDAppleScriptObject</tt> from a <tt>NSAppleEventDescriptor</tt>.
 */
@interface NSAppleEventDescriptor (NDAppleScriptObjectValueExtension)
/*!
	@method appleScriptValue
 * @brief Category method for <tt>NSAppleEventDescriptor (NDAppleScriptObjectValueExtension)</tt>, converts any script data within a AppleEvent descriptor into an <tt>NDAppleScriptObject</tt>
 *
* If an AppleScript return a AppleScript as it&rsquo;s result, this method can be used to convert the result <tt>NSAppleEventDescriptor</tt> into a <tt>NDAppleScriptObject</tt>. The <tt>NSAppleEventDescriptor</tt> method objectValue will use this method if available.
 * @return A <tt>NDAppleScriptObject</tt> object for the AppleScript contained within the AppleEvent descriptor.
  */
 ...
 * @brief Provides interface compatibility with Apple&rsquo;s <tt>NSAppleScript</tt>
 *
* Adds methods to <tt>NDAppleScriptObject</tt> to make it interface compatible with <tt>NSAppleScript</tt>. The methods are <tt>initWithContentsOfURL:error:</tt>, <tt>initWithSource:</tt>, <tt>compileAndReturnError:</tt>, <tt>executeAndReturnError:</tt> and <tt>executeAppleEvent:error:</tt>.
 */
@interface NDAppleScriptObject (NSAppleScriptCompatibility)
/*!
	@method initWithContentsOfURL:error:
 * @brief Initialize a <tt>NDAppleScriptObject</tt>.
 *
* This method is for interface compatibility with Apple&rsquo;s <tt>NSAppleScript</tt>
	@param url A file URL for the compiled AppleScript file.
	@param errorInfo On return contains a <tt>NSDictionary</tt> contain error information.
 * @return An initalized <tt>NDAppleScriptObject</tt>
  */
 ...
 * @brief Initialize a <tt>NDAppleScriptObject</tt>.
 *
* This method is for interface compatibility with Apple&rsquo;s <tt>NSAppleScript</tt>, it is equivalent to <tt>initWithString:</tt> but without compiling of the source.
 * @return A <tt>NDAppleScriptObject</tt> object.
  */
- (id)initWithSource:(NSString *)source;

/*!
	@method compileAndReturnError:
 * @brief Compile an AppleScript.
 *
* This method is for interface compatibility with Apple&rsquo;s <tt>NSAppleScript</tt>
 ...
 * @return Returns <tt>YES</tt> on success.
  */
...
* This method is for interface compatibility with Apple&rsquo;s <tt>NSAppleScript</tt>
	@param event  An <tt>NSAppleEventDescriptor</tt> containing the apple event.
	@param errorInfo If execution fails, this is set to an <tt>NSDictionary</tt> containing error information. Otherwise, it is set to nil.
 * @return Returns the result <tt>NSAppleEventDescriptor</tt> on success, <tt>nil</tt> otherwise.
  */
