/*!
	...
	@brief Decalres the category <tt>NSString (NDCarbonUtilities)</tt>
...
/*!
	...
	@brief Alloc and initialize an <tt>NSString</tt>.
...
/*!
	@method getFSRef:
	@brief Get a <tt>FSRef</tt> for a path <tt>NSString</tt>.
...
/*!
	...
	@brief Get a path from a HFS style path.
...
/*!
	...
	@brief Obtain a pascal string equivelent to the receveiver.
...
/*!
	...
	@brief Trims white space from a <tt>NSString</tt>.
