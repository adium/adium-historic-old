/*!
	@header NSAppleEventDescriptor+NDScriptData
	@abstract Declares the category <tt>NSAppleEventDescriptor (NDScriptData)</tt>
 ...
 */
+ (id)descriptorWithEventClass:(AEEventClass)eventClass eventID:(AEEventID)eventID;
/*!
...
/*!
	...
	@result A <tt>NSAppleEventDescriptor</tt> for a record descriptor.
 */
+ (id)descriptorWithScriptObjectSpecifier:(NSScriptObjectSpecifier *)objectSpecifier;
...
/*!
	@protocol NDAttachedScriptData
	@abstract Informal protocol for return attached script data.
	@discussion <tt>NDAttachedScriptData</tt> implements an single method <tt>attachedScript</tt>.
*/
@interface NSObject (NDAttachedScriptData)
/*!
	@method attachedScript
	@abstract <#Abstract#>
	@discussion <#Discussion#>
	@result <#result#>
 */
- (NDScriptData *)attachedScript;
@end
