 ...
 * @result A set with all the results or <code>nil</code> if the receiver contains no objects.
 */
 ...
 * @result A set with all objects that returned <code>YES</code> for the last message, or <code>nil</code> if none was found.
 */
 ...
 * All other messages must return an object or a class, otherwise the result is undefined.
 * The passed messages list must be <code>nil<code> terminated.
 * @result A set with all objects that returned <code>NO</code> for the last message, or <code>nil</code> if none was found.
 */
 ...
 * <code>[[mySet each] setString:@"hello"];</code>
 */
- (id)each;
