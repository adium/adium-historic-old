...
+ (void)showCustomSocialNetworkingStatusWindow:(NSMenuItem *)sender
{
	...
	NSAttributedString *currentStatusMessage = (account ?
												...
												[[[[AIObject sharedAdiumInstance] statusController] activeStatusState] statusMessage]);
...
{
	//Filter the content
	[[[AIObject sharedAdiumInstance] contentController] filterAttributedString:inStatusMessage
...
{
	AIAccount *account = [sender representedObject];
	NSAttributedString *currentStatusMessage = [[[[AIObject sharedAdiumInstance] statusController] activeStatusState] statusMessage];
