...
- (void)installPlugin
{
    ...
    [[owner preferenceController] registerDefaults:[NSDictionary dictionaryWithObjectsAndKeys: 
        [NSNumber numberWithBool:5], @"dock_bounce_onDidReceiveContent_num", nil]
    forGroup:@"DockBehavior"];
