...
- (id)initForOwner:(id)inOwner account:(id)inAccount
{
    ...
    //this needs to be cleaned up (i don't have the docs on hand, can someone get the right info?)
    [textField_email setFormatter:[AIStringFormatter stringFormatterAllowingCharacters:[NSCharacterSet characterSetWithCharactersInString:@"abcdefghijklmnopqrstuvwxyz0123456789_.@ "] length:48 caseSensitive:NO errorMessage:@"Improper Format"]];
    
    //this too
    [textField_friendlyName setFormatter:[AIStringFormatter stringFormatterAllowingCharacters:[NSCharacterSet characterSetWithCharactersInString:@"abcdefghijklmnopqrstuvwxyz0123456789_.@!#$%^&*() "] length:255 caseSensitive:NO errorMessage:@"Improper Format"]];
