...
@interface AIGaimAccountViewController (PRIVATE)
...
- (void)configureViewAfterLoad
{
    ...
    //ScreenName
    savedScreenName = [account preferenceForKey:@"Handle" group:GROUP_ACCOUNT_STATUS];
...
- (id)initForAccount:(id)inAccount
{
    ...
    if(![NSBundle loadNibNamed:@"GaimOscarAIMAccountView" owner:self]){
...
- (void)_delayedChangeTo:(NSString *)toName{
    ...
    [targetAccount setPreference:toName forKey:@"Handle" group:GROUP_ACCOUNT_STATUS];
}
