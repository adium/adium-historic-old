...
@interface AIOscarStats (PRIVATE)
- (void)_handleReportInterval:(AIOscarPacket *)inPacket;
@end

@implementation AIOscarStats
...
{
    switch(type){
        case 0x0002: [self _handleReportInterval:inPacket]; break;
...
- (void)_handleReportInterval:(AIOscarPacket *)inPacket
{
    ...
    [inPacket getShortValue:&interval];
