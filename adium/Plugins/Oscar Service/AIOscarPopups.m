...
@interface AIOscarPopups (PRIVATE)
- (void)_handlePopup:(AIOscarPacket *)inPacket;
@end

@implementation AIOscarPopups
...
{
    switch(type){
        case 0x0002: [self _handlePopup:inPacket]; break;
...
- (void)_handlePopup:(AIOscarPacket *)inPacket
{
    NSLog(@"_handlePopup (Not implemented)"); //Not implemented
}
