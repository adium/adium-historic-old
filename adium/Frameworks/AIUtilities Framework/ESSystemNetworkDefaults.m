...
+ (NSDictionary *)systemProxySettingsDictionaryForType:(ProxyType)proxyType
{
	...
	switch(proxyType){
		case Proxy_HTTP: {
			enableKey = (CFNumberRef)kSCPropNetProxiesHTTPEnable;
			portKey = (CFNumberRef)kSCPropNetProxiesHTTPPort;
			proxyKey = kSCPropNetProxiesHTTPProxy;
			break;
		}
		case Proxy_SOCKS4:
		case Proxy_SOCKS5: {
			enableKey = (CFNumberRef)kSCPropNetProxiesSOCKSEnable;
			portKey = (CFNumberRef)kSCPropNetProxiesSOCKSPort;
			proxyKey = kSCPropNetProxiesSOCKSProxy;
			break;
		}
		case Proxy_HTTPS: {
			enableKey = (CFNumberRef)kSCPropNetProxiesHTTPSEnable;
			portKey = (CFNumberRef)kSCPropNetProxiesHTTPSPort;
			proxyKey = kSCPropNetProxiesHTTPSProxy;
			break;
		}
		case Proxy_FTP: {
			enableKey = (CFNumberRef)kSCPropNetProxiesFTPEnable;
			portKey = (CFNumberRef)kSCPropNetProxiesFTPPort;
			proxyKey = kSCPropNetProxiesFTPProxy;
			break;
		}
		case Proxy_RTSP: {
			enableKey = (CFNumberRef)kSCPropNetProxiesRTSPEnable;
			portKey = (CFNumberRef)kSCPropNetProxiesRTSPPort;
			proxyKey = kSCPropNetProxiesRTSPProxy;
			break;
		}
		case Proxy_Gopher: {
			enableKey = (CFNumberRef)kSCPropNetProxiesGopherEnable;
			portKey = (CFNumberRef)kSCPropNetProxiesGopherPort;
