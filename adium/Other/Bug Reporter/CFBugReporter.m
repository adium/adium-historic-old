...
#define BUG_REPORTER_URL		
// We need to report to sf.net instead of visual distortion for this. Leaving in the url for now in case we have to use visual distortion.@"http://www.visualdistortion.org/bugreporter/post.jsp" 
//#define EXCEPTIONS_PATH		[@"~/Library/Logs/CrashReporter/Adium.exception.log" stringByExpandingTildeInPath]
//#define CRASHES_PATH		[@"~/Library/Logs/CrashReporter/Adium..log" stringByExpandingTildeInPath]

#define KEY_BUG_EMAIL_ADDRESS		@"AdiumBugReporterEmailAddress"
#define KEY_BUG_AIM_ACCOUNT		@"AdiumBugReporterAIMAccount"

#define BUG_REPORT_SLAY_ATTEMPTS		100
#define BUG_REPORT_SLAY_INTERVAL		0.1

//#define CRASH_LOG_WAIT_ATTEMPTS			100
//#define CRASH_LOG_WAIT_INTERVAL			0.2

@implementation CFBugReporter

//
//Nothing will need to be told to quit, this should be a menu item, and not have to launch on crash
/*- (id)init
{
    [super init];
