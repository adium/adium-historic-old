        ...
        <div id="central">
			...
			<span class="teamData">MSN:</span>ramoth4x@hotmail.com<br />
                    ...
                    <div class="teamMember">
                        ...
                        <span class="teamData">Email:</span>dcclark[at]mtu[dot]edu<br />
                        <span class="teamData">AIM:</span>wlc98clark<br />
                        <span class="teamData">MSN:</span>dchoby98@hotmail.com<br />
                        <span class="teamData">Jabber:</span>dcclark@jabber.org
                    </div>
                     <div class="teamMember">
