            ...
            <div id="content">
                ...
                <div class="boxWideContent">
                    ...
                    <p>You will then come to a web page that looks a little like this:</p><br />
                     ...
                     <div class="irchowto">
                    <p>Click on the picture under the download column on the right. The trick to this page is to figure out which of these places is closest to you, which makes it a much faster download.</p>                    </div>
