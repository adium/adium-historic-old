	   ...
	   <div id="banner">
        ...
        <div id="central">
            ...
            <div id="content">
                ...
                <p><span class="faqQuestion">Does Adium support
                blocking?</span><br />
                No, Adium does not currently support blocking.  However, if
                you block someone with the official client, Adium will respect
                it.</p>
