...
<script language="javascript" type="text/javascript">
 function OpenLink(c){
   window.open(c, 'link', 'width=640,height=480,scrollbars=yes,status=yes,toolbar=no');
 }
 function OpenUberLink(c){
   window.open(c, 'link', 'width=720,height=480,scrollbars=yes,status=yes,toolbar=no');
 }
</script>
</head>
<body>
        ...
        <div id="central">
            ...
            <div id="sidebar-a">
                ...
                <div class="boxThinContent">
                    <p><a href="history.html" onclick="OpenLink(this.href); return false">Version history</a><br />
                    <span class="tiny">What's new in Adium</span></p>
                    <p><a href="http://cvs.sourceforge.net/viewcvs.py/adium/adium/Bugs.txt?view=markup" onclick="OpenUberLink(this.href); return false">Known Issues</a><br />
					 <span class="tiny">Bugs in the current release</span></p>
                ...
                <div class="boxThinTop"></div>
                <div class="boxThinContent">
                    <p><a href="http://forum.adiumx.com">Adium Forum</a><br />
                    <span class="tiny">Discuss ideas, issues, or concerns with other users.</span></p>
                    <p><a href="./irc.php">Adium IRC Channel</a><br />
                    <span class="tiny">Join us in #adium on irc.freenode.net for live chat.</span></p>
                </div>
                <div class="boxThinBottom"></div>
                <h1>News Archives</h1>
                <div class="boxThinTop"></div>
