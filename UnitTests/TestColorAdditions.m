...
- (void)testHSLFromRGBForRed
{
	...
	float h, s, l;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(h, (0.0f / 6.0f), @"The hue angle of red should be a multiple of one whole circle, which generally means exactly 0");
	STAssertEquals(s,  1.0f,         @"The saturation of red, or any other pure color, should be 1");
	STAssertEquals(l,  1.0f,         @"The brightness of red, or any other pure color, should be 1");
}
- (void)testHSLFromRGBForYellow
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(h, (1.0f / 6.0f), @"The hue angle of cyan should be one-sixth of a circle");
	STAssertEquals(s,  1.0f,         @"The saturation of cyan, or any other pure color, should be 1");
	STAssertEquals(l,  1.0f,         @"The brightness of cyan, or any other pure color, should be 1");
}
- (void)testHSLFromRGBForGreen
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(h, (2.0f / 6.0f), @"The hue angle of cyan should be one-third of a circle");
	STAssertEquals(s,  1.0f,         @"The saturation of cyan, or any other pure color, should be 1");
	STAssertEquals(l,  1.0f,         @"The brightness of cyan, or any other pure color, should be 1");
}
- (void)testHSLFromRGBForCyan
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(h, (3.0f / 6.0f), @"The hue angle of cyan should be one-half of a circle");
	STAssertEquals(s,  1.0f,       @"The saturation of cyan, or any other pure color, should be 1");
	STAssertEquals(l,  1.0f,       @"The brightness of cyan, or any other pure color, should be 1");
}
- (void)testHSLFromRGBForBlue
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(h, (4.0f / 6.0f), @"The hue angle of blue should be two-thirds of a circle");
	STAssertEquals(s,  1.0f,         @"The saturation of blue, or any other pure color, should be 1");
	STAssertEquals(l,  1.0f,         @"The brightness of blue, or any other pure color, should be 1");
}
- (void)testHSLFromRGBForMagenta
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(h, (5.0f / 6.0f), @"The hue angle of magenta should be five-sixths of a circle");
	STAssertEquals(s,  1.0f,         @"The saturation of magenta, or any other pure color, should be 1");
	STAssertEquals(l,  1.0f,         @"The brightness of magenta, or any other pure color, should be 1");
}
- (void)testHSLFromRGBForWhite
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(s,  0.0f,      @"The saturation of white should be 0");
	STAssertEquals(l,  1.0f,      @"The brightness of white, or any other pure color, should be 1");
}
- (void)testHSLFromRGBForBlack
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(l,  0.0f,      @"The brightness of black should be 1");
}
- (void)testHSLFromRGBForGray
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(s,  0.0f,      @"The saturation of gray should be 0");
	STAssertEquals(l,  0.5f,      @"The brightness of gray should be 0.5");
}

#pragma mark getRGBFromHueLuminanceSaturation
- (void)testRGBFromHSLForRed
{
	float h = (0.0 / 6.0), s = 1.0, l = 1.0;
	float r, g, b;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 1.0f, @"The red component of red should be 1");
	STAssertEquals(g, 0.0f, @"The green component of red should be 0");
	STAssertEquals(b, 0.0f, @"The blue component of red should be 0");
}
- (void)testRGBFromHSLForYellow
{
	float h = (1.0 / 6.0), s = 1.0, l = 1.0;
	float r, g, b;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 1.0f, @"The red component of yellow should be 1");
	STAssertEquals(g, 1.0f, @"The green component of yellow should be 1");
	STAssertEquals(b, 0.0f, @"The blue component of yellow should be 0");
}
- (void)testRGBFromHSLForGreen
{
	float h = (2.0 / 6.0), s = 1.0, l = 1.0;
	float r, g, b;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 0.0f, @"The red component of green should be 0");
	STAssertEquals(g, 1.0f, @"The green component of green should be 1");
	STAssertEquals(b, 0.0f, @"The blue component of green should be 0");
}
- (void)testRGBFromHSLForCyan
{
	float h = (3.0 / 6.0), s = 1.0, l = 1.0;
	float r, g, b;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 0.0f, @"The red component of cyan should be 0");
	STAssertEquals(g, 1.0f, @"The green component of cyan should be 1");
	STAssertEquals(b, 1.0f, @"The blue component of cyan should be 1");
}
- (void)testRGBFromHSLForBlue
{
	float h = (4.0 / 6.0), s = 1.0, l = 1.0;
	float r, g, b;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 0.0f, @"The red component of blue should be 0");
	STAssertEquals(g, 0.0f, @"The green component of blue should be 0");
	STAssertEquals(b, 1.0f, @"The blue component of blue should be 1");
}
- (void)testRGBFromHSLForMagenta
{
	float h = (5.0 / 6.0), s = 1.0, l = 1.0;
	float r, g, b;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 1.0f, @"The red component of magenta should be 1");
	STAssertEquals(g, 0.0f, @"The green component of magenta should be 0");
	STAssertEquals(b, 1.0f, @"The blue component of magenta should be 1");
}
- (void)testRGBFromHSLForWhite
{
	float h = 0.0, s = 0.0, l = 1.0;
	float r, g, b;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 1.0f, @"The red component of white should be 1");
	STAssertEquals(g, 1.0f, @"The green component of white should be 1");
	STAssertEquals(b, 1.0f, @"The blue component of white should be 1");
}
- (void)testRGBFromHSLForBlack
{
	...
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 0.0f, @"The red component of black should be 0");
	STAssertEquals(g, 0.0f, @"The green component of black should be 0");
	STAssertEquals(b, 0.0f, @"The blue component of black should be 0");
}
- (void)testRGBFromHSLForGray
{
	float h = 0.0, s = 0.0, l = 0.5;
	float r, g, b;
	getHueLuminanceSaturationFromRGB(&h, &l, &s,
									  r,  g,  b);
	STAssertEquals(r, 0.5f, @"The red component of black should be 0.5");
	STAssertEquals(g, 0.5f, @"The green component of black should be 0.5");
	STAssertEquals(b, 0.5f, @"The blue component of black should be 0.5");
}
