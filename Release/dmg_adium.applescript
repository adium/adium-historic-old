...
on process_disk_image(volumeName, artPath)
	tell application "Finder"
		tell disk (volumeName as string)
			...
			set position of item "Applications" to {394, 273}
			set position of item "License.txt" to {512, 290}
			set position of item "Changes.txt" to {73, 290}
			
			-- Custom icons
			my copyIconOfTo(artPath & "/ApplicationsIcon", "/Volumes/" & volumeName & "/Applications")
			my copyIconOfTo(artPath & "/TextIcon", "/Volumes/" & volumeName & "/License.txt")
			my copyIconOfTo(artPath & "/TextIcon", "/Volumes/" & volumeName & "/Changes.txt")
			my copyIconOfTo(artPath & "/DiskImageIcon", "/Volumes/" & volumeName)
