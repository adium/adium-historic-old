...
localizable-strings:
	...
	genstrings -o Resources/en.lproj -s AILocalizedString Source/*.m Source/*.h Plugins/*/*.h Plugins/*/*.m Plugins/*/*/*.h Plugins/*/*/*.m "Frameworks/Adium Framework/*.m" "Frameworks/Adium Framework/*.h"
