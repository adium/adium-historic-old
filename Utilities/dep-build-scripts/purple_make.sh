...
# libpurple_jabber_cert_against_jid_hostname.diff  - im.pidgin.pidgin 6227c43549bf66022512f18bb36d70b7c57c4430
###
...
for patch in "$PATCHDIR/libpurple_makefile_linkage_hacks.diff" \
             ...
             "$PATCHDIR/libpurple_jabber_cert_against_jid_hostname.diff" ; do
    echo "Applying $patch"
