...
#define	ACCOUNT_CONNECT_BUTTON_TITLE		NSLocalizedString(@"Connect","Connect an account")	    	//Menu item title for the connect item
#define	ACCOUNT_DISCONNECT_BUTTON_TITLE		NSLocalizedString(@"Disconnect","Disconnect an account")    //Menu item title
#define	ACCOUNT_CONNECTING_BUTTON_TITLE		AILocaliedString(@"Connecting...",nil)						//Menu item title
#define	ACCOUNT_DISCONNECTING_BUTTON_TITLE	NSLocalizedString(@"Disconnecting...",nil)					//Menu item title
