...
#define SHOW_MAIN_WINDOW    NSLocalizedString(@"Show Main Window...",nil)
#define CLOSE		    NSLocalizedString(@"Close",nil)
#define HIDE_CONTACT_LIST   NSLocalizedString(@"Hide Contact List",nil)
