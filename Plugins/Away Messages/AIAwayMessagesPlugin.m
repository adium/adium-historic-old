...
#define AWAY_MESSAGE_MENU_TITLE			NSLocalizedString(@"Set Away Message",nil)
#define AWAY_MESSAGE_MENU_TITLE_SHORT   NSLocalizedString(@"Set Away",nil)
#define	REMOVE_AWAY_MESSAGE_MENU_TITLE  NSLocalizedString(@"Remove Away Message",nil)
#define	CUSTOM_AWAY_MESSAGE_MENU_TITLE  NSLocalizedString(@"Custom Message...",nil)
