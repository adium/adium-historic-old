...
{
	return [NSURL URLWithString:[NSString stringWithFormat:@"http://0.channel%@.facebook.com/x/0/false/p_%@=%i", channel, facebookUID, sequenceNumber]];
}
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	if ([command isEqualToString:@"refresh"]) {
		...
		sequenceNumber = [[reply objectForKey:@"seq"] intValue];
