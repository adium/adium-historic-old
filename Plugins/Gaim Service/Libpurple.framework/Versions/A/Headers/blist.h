...
#define GAIM_BLIST_NODE_NAME(n) ((n)->type == GAIM_BLIST_CHAT_NODE  ? purple_chat_get_name((GaimChat*)n) :        \
				     (n)->type == GAIM_BLIST_BUDDY_NODE ? purple_buddy_get_name((GaimBuddy*)n) : NULL)
 ...
 */
GaimBuddyList *purple_blist_new(void);
 ...
 */
void purple_set_blist(GaimBuddyList *blist);
 ...
 */
GaimBuddyList *purple_get_blist(void);
 ...
 */
GaimBlistNode *purple_blist_get_root(void);
 ...
 */
GaimBlistNode *purple_blist_node_next(GaimBlistNode *node, gboolean offline);
 ...
 */
void purple_blist_update_buddy_status(GaimBuddy *buddy, GaimStatus *old_status);
 ...
 */
void purple_blist_update_buddy_icon(GaimBuddy *buddy);
 ...
 */
void purple_blist_rename_buddy(GaimBuddy *buddy, const char *name);
 ...
 */
void purple_blist_alias_contact(GaimContact *contact, const char *alias);
 ...
 */
void purple_blist_alias_buddy(GaimBuddy *buddy, const char *alias);
 ...
 */
void purple_blist_server_alias_buddy(GaimBuddy *buddy, const char *alias);
 ...
 */
void purple_blist_alias_chat(GaimChat *chat, const char *alias);
 ...
 */
void purple_blist_rename_group(GaimGroup *group, const char *name);
 ...
 */
GaimChat *purple_chat_new(GaimAccount *account, const char *alias, GHashTable *components);
 ...
 */
void purple_blist_add_chat(GaimChat *chat, GaimGroup *group, GaimBlistNode *node);
 ...
 */
GaimBuddy *purple_buddy_new(GaimAccount *account, const char *screenname, const char *alias);
 ...
 */
void purple_buddy_set_icon(GaimBuddy *buddy, GaimBuddyIcon *icon);
 ...
 * @return The account
 */
GaimAccount *purple_buddy_get_account(const GaimBuddy *buddy);
 ...
 * @return The name.
 */
const char *purple_buddy_get_name(const GaimBuddy *buddy);
 ...
 */
GaimBuddyIcon *purple_buddy_get_icon(const GaimBuddy *buddy);
 ...
 */
GaimContact *purple_buddy_get_contact(GaimBuddy *buddy);
 ...
 */
GaimPresence *purple_buddy_get_presence(const GaimBuddy *buddy);
 ...
 * @param node    The insertion point
 */
void purple_blist_add_buddy(GaimBuddy *buddy, GaimContact *contact, GaimGroup *group, GaimBlistNode *node);
...
*/
GaimGroup *purple_group_new(const char *name);
 ...
 * @param node   The insertion point
 */
void purple_blist_add_group(GaimGroup *group, GaimBlistNode *node);
 ...
 */
GaimContact *purple_contact_new(void);
 ...
 * @param node    The insertion point
 */
void purple_blist_add_contact(GaimContact *contact, GaimGroup *group, GaimBlistNode *node);
 ...
 */
void purple_blist_merge_contact(GaimContact *source, GaimBlistNode *node);
 ...
 */
GaimBuddy *purple_contact_get_priority_buddy(GaimContact *contact);
 ...
 */
void purple_contact_set_alias(GaimContact *contact, const char *alias);
 ...
 */
const char *purple_contact_get_alias(GaimContact *contact);
 ...
 */
gboolean purple_contact_on_account(GaimContact *contact, GaimAccount *account);
 ...
 * @param contact  The contact
 */
void purple_contact_invalidate_priority_buddy(GaimContact *contact);
/**
 * Removes a buddy from the buddy list and frees the memory allocated to it.
 *
 * @param buddy   The buddy to be removed
 */
void purple_blist_remove_buddy(GaimBuddy *buddy);
 ...
 */
void purple_blist_remove_contact(GaimContact *contact);
 ...
 */
void purple_blist_remove_chat(GaimChat *chat);
 ...
 */
void purple_blist_remove_group(GaimGroup *group);
 ...
 *                or NULL.
 */
const char *purple_buddy_get_alias_only(GaimBuddy *buddy);
 ...
 */
const char *purple_buddy_get_server_alias(GaimBuddy *buddy);
 ...
 *
 */
const char *purple_buddy_get_contact_alias(GaimBuddy *buddy);
 ...
 */
const char *purple_buddy_get_local_alias(GaimBuddy *buddy);
 ...
 * @return        The appropriate name or alias, or NULL
 */
const char *purple_buddy_get_alias(GaimBuddy *buddy);
 ...
 */
const char *purple_chat_get_name(GaimChat *chat);
 ...
 */
GaimBuddy *purple_find_buddy(GaimAccount *account, const char *name);
 ...
 */
GaimBuddy *purple_find_buddy_in_group(GaimAccount *account, const char *name,
		GaimGroup *group);
 ...
 */
GSList *purple_find_buddies(GaimAccount *account, const char *name);
 ...
 */
GaimGroup *purple_find_group(const char *name);
 ...
 */
GaimChat *purple_blist_find_chat(GaimAccount *account, const char *name);
 ...
 */
GaimGroup *purple_chat_get_group(GaimChat *chat);
 ...
 */
GaimGroup *purple_buddy_get_group(GaimBuddy *buddy);
 ...
 */
GSList *purple_group_get_accounts(GaimGroup *g);
 ...
 */
gboolean purple_group_on_account(GaimGroup *g, GaimAccount *account);
 ...
 * @param account   The account
 */
void purple_blist_add_account(GaimAccount *account);
 ...
 * @param account   The account
 */
void purple_blist_remove_account(GaimAccount *account);
 ...
 */
int purple_blist_get_group_size(GaimGroup *group, gboolean offline);
 ...
 */
int purple_blist_get_group_online_count(GaimGroup *group);
 ...
 */
void purple_blist_request_add_buddy(GaimAccount *account, const char *username,
								  const char *group, const char *alias);
 ...
 */
void purple_blist_request_add_chat(GaimAccount *account, GaimGroup *group,
								 const char *alias, const char *name);
 ...
 */
void purple_blist_node_set_bool(GaimBlistNode *node, const char *key, gboolean value);
 ...
 */
gboolean purple_blist_node_get_bool(GaimBlistNode *node, const char *key);
 ...
 * @param value The value to set
 */
void purple_blist_node_set_int(GaimBlistNode *node, const char *key, int value);
 ...
 */
int purple_blist_node_get_int(GaimBlistNode *node, const char *key);
 ...
 * @param value The value to set
 */
void purple_blist_node_set_string(GaimBlistNode *node, const char *key,
		const char *value);
 ...
 */
const char *purple_blist_node_get_string(GaimBlistNode *node, const char *key);
 ...
 */
void purple_blist_node_remove_setting(GaimBlistNode *node, const char *key);
 ...
 */
void purple_blist_node_set_flags(GaimBlistNode *node, GaimBlistNodeFlags flags);
 ...
 */
GaimBlistNodeFlags purple_blist_node_get_flags(GaimBlistNode *node);
 ...
 */
GList *purple_blist_node_get_extended_menu(GaimBlistNode *n);
 ...
 */
void purple_blist_set_ui_ops(GaimBlistUiOps *ops);
 ...
 */
GaimBlistUiOps *purple_blist_get_ui_ops(void);
