 ...
 */
GaimMimeDocument *purple_mime_document_new(void);
 ...
 */
void purple_mime_document_free(GaimMimeDocument *doc);
 ...
 */
GaimMimeDocument *purple_mime_document_parse(const char *buf);
 ...
 * @returns   A MIME document.
 */
GaimMimeDocument *purple_mime_document_parsen(const char *buf, gsize len);

/**
 * Write (append) a MIME document onto a GString.
 */
void purple_mime_document_write(GaimMimeDocument *doc, GString *str);
 ...
 */
const GList *purple_mime_document_get_fields(GaimMimeDocument *doc);
 ...
 */
const char *purple_mime_document_get_field(GaimMimeDocument *doc,
					 const char *field);
 ...
 */
void purple_mime_document_set_field(GaimMimeDocument *doc,
				  const char *field,
				  const char *value);
 ...
 */
const GList *purple_mime_document_get_parts(GaimMimeDocument *doc);
 ...
 */
GaimMimePart *purple_mime_part_new(GaimMimeDocument *doc);
 ...
 */
const GList *purple_mime_part_get_fields(GaimMimePart *part);
 ...
 *              field doesn't exist.
 */
const char *purple_mime_part_get_field(GaimMimePart *part,
				     const char *field);
 ...
 * document part.
 */
char *purple_mime_part_get_field_decoded(GaimMimePart *part,
				       const char *field);
 ...
 *              of NULL to remove the field.
 */
void purple_mime_part_set_field(GaimMimePart *part,
			      const char *field,
			      const char *value);
 ...
 */
const char *purple_mime_part_get_data(GaimMimePart *part);
 ...
 */
void purple_mime_part_get_data_decoded(GaimMimePart *part,
 ...
 */
gsize purple_mime_part_get_length(GaimMimePart *part);

void purple_mime_part_set_data(GaimMimePart *part, const char *data);
