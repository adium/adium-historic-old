// _DCGaimYahooJoinChatView_EOArchive_pl.java
// Generated by EnterpriseObjects palette at niedziela, 27 listopada 2005 00:44:02 Europe/Warsaw
...
public class _DCGaimYahooJoinChatView_EOArchive_pl extends com.webobjects.eoapplication.EOArchive {
    ...
    public _DCGaimYahooJoinChatView_EOArchive_pl(Object owner, NSDisposableRegistry registry) {
    ...
    protected void _construct() {
        ...
        _nsTextField6 = (com.webobjects.eointerface.swing.EOTextField)_registered(new com.webobjects.eointerface.swing.EOTextField(), "NSTextField2112");
        _nsTextField5 = (com.webobjects.eointerface.swing.EOTextField)_registered(new com.webobjects.eointerface.swing.EOTextField(), "NSTextField112");
        _nsTextField4 = (com.webobjects.eointerface.swing.EOTextField)_registered(new com.webobjects.eointerface.swing.EOTextField(), "NSTextField212");
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "textField_roomName.nextFocusableComponent.nextFocusableComponent")) != null)) {
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "textField_roomName.nextFocusableComponent")) != null)) {
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "textField_roomName.nextFocusableComponent.nextFocusableComponent.nextFocusableComponent")) != null)) {
    ...
    protected void _awaken() {
        ...
        if (_replacedObjects.objectForKey("_nsTextField1") == null) {
            _connect(_owner(), _nsTextField1, "textField_inviteUsers");
        }

        if (_replacedObjects.objectForKey("_nsTextField0") == null) {
            _connect(_owner(), _nsTextField0, "textField_roomName");
        }
        ...
        if (_replacedObjects.objectForKey("_nsTextField2") == null) {
            _connect(_owner(), _nsTextField2, "textField_inviteMessage");
        }
    }
    ...
    protected void _init() {
        ...
        _nsTextField6.setText("Zapro\u015b kontakty:");
        ...
        _nsTextField5.setText("Oddziel nazwy kontakt\u00f3w przecinkami.");
        ...
        if (_replacedObjects.objectForKey("_nsCustomView0") == null) {
            ...
            _nsTextField0.setSize(266, 22);
            _nsTextField0.setLocation(124, 1);
            ...
            _nsTextField2.setLocation(124, 109);
            ...
            _nsTextField4.setLocation(-1, 112);
            ...
            _nsTextField5.setSize(224, 14);
            _nsTextField5.setLocation(121, 91);
            ...
            _nsTextField1.setLocation(124, 31);
            ...
            _nsTextField6.setLocation(-1, 34);
