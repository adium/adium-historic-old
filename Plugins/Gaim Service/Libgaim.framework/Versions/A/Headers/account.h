 ...
 */
GaimAccount *purple_account_new(const char *username, const char *protocol_id);
 ...
 */
void purple_account_destroy(GaimAccount *account);
 ...
 */
void purple_account_connect(GaimAccount *account);
 ...
 */
void purple_account_register(GaimAccount *account);
 ...
 */
void purple_account_disconnect(GaimAccount *account);
 ...
 */
void purple_account_notify_added(GaimAccount *account, const char *remote_user,
                               const char *id, const char *alias,
                               const char *message);
 ...
 * @param message     The optional message sent from the user adding you.
 */
void purple_account_request_add(GaimAccount *account, const char *remote_user,
                              const char *id, const char *alias,
                              const char *message);
 ...
 */
void *purple_account_request_authorization(GaimAccount *account, const char *remote_user,
 ...
 */
void purple_account_request_close_with_account(GaimAccount *account);
 ...
 */
void purple_account_request_change_password(GaimAccount *account);
 ...
 */
void purple_account_request_change_user_info(GaimAccount *account);
 ...
 * @param username The username.
 */
void purple_account_set_username(GaimAccount *account, const char *username);
 ...
 */
void purple_account_set_password(GaimAccount *account, const char *password);
 ...
 */
void purple_account_set_alias(GaimAccount *account, const char *alias);
 ...
 */
void purple_account_set_user_info(GaimAccount *account, const char *user_info);
 ...
 */
void purple_account_set_buddy_icon(GaimAccount *account, const char *icon);
 ...
 */
void purple_account_set_buddy_icon_path(GaimAccount *account, const char *path);
 ...
 * @param protocol_id The protocol ID.
 */
void purple_account_set_protocol_id(GaimAccount *account,
 ...
 */
void purple_account_set_connection(GaimAccount *account, GaimConnection *gc);
 ...
 */
void purple_account_set_remember_password(GaimAccount *account, gboolean value);
 ...
 */
void purple_account_set_check_mail(GaimAccount *account, gboolean value);
 ...
 */
void purple_account_set_enabled(GaimAccount *account, const char *ui,
			      gboolean value);
 ...
 */
void purple_account_set_proxy_info(GaimAccount *account, GaimProxyInfo *info);
 ...
 */
void purple_account_set_status_types(GaimAccount *account, GList *status_types);
 ...
 */
void purple_account_set_status(GaimAccount *account, const char *status_id,
							 gboolean active, ...);
 ...
 */
void purple_account_set_status_list(GaimAccount *account,
 ...
 * @param account The account.
 */
void purple_account_clear_settings(GaimAccount *account);
 ...
 */
void purple_account_set_int(GaimAccount *account, const char *name, int value);
 ...
 * @param value   The setting's value.
 */
void purple_account_set_string(GaimAccount *account, const char *name,
							 const char *value);
 ...
 * @param value   The setting's value.
 */
void purple_account_set_bool(GaimAccount *account, const char *name,
						   gboolean value);
 ...
 * @param value   The setting's value.
 */
void purple_account_set_ui_int(GaimAccount *account, const char *ui,
 ...
 * @param value   The setting's value.
 */
void purple_account_set_ui_string(GaimAccount *account, const char *ui,
 ...
 * @param value   The setting's value.
 */
void purple_account_set_ui_bool(GaimAccount *account, const char *ui,
 ...
 */
gboolean purple_account_is_connected(const GaimAccount *account);
 ...
 */
gboolean purple_account_is_connecting(const GaimAccount *account);
 ...
 */
gboolean purple_account_is_disconnected(const GaimAccount *account);
 ...
 * @return The username.
 */
const char *purple_account_get_username(const GaimAccount *account);
 ...
 * @return The password.
 */
const char *purple_account_get_password(const GaimAccount *account);
 ...
 * @return The alias.
 */
const char *purple_account_get_alias(const GaimAccount *account);
 ...
 */
const char *purple_account_get_user_info(const GaimAccount *account);
 ...
 */
const char *purple_account_get_buddy_icon(const GaimAccount *account);
 ...
 */
const char *purple_account_get_buddy_icon_path(const GaimAccount *account);
 ...
 */
const char *purple_account_get_protocol_id(const GaimAccount *account);
 ...
 */
const char *purple_account_get_protocol_name(const GaimAccount *account);
 ...
 */
GaimConnection *purple_account_get_connection(const GaimAccount *account);
 ...
 */
gboolean purple_account_get_remember_password(const GaimAccount *account);
 ...
 */
gboolean purple_account_get_check_mail(const GaimAccount *account);
 ...
 */
gboolean purple_account_get_enabled(const GaimAccount *account,
				  const char *ui);
 ...
 */
GaimProxyInfo *purple_account_get_proxy_info(const GaimAccount *account);
 ...
 */
GaimStatus *purple_account_get_active_status(const GaimAccount *account);
 ...
 */
GaimStatus *purple_account_get_status(const GaimAccount *account,
									const char *status_id);
 ...
 */
GaimStatusType *purple_account_get_status_type(const GaimAccount *account,
											 const char *id);
 ...
 */
GaimStatusType *purple_account_get_status_type_with_primitive(
 ...
 */
GaimPresence *purple_account_get_presence(const GaimAccount *account);
 ...
 */
gboolean purple_account_is_status_active(const GaimAccount *account,
									   const char *status_id);
 ...
 */
const GList *purple_account_get_status_types(const GaimAccount *account);
 ...
 * @return The value.
 */
int purple_account_get_int(const GaimAccount *account, const char *name,
						 int default_value);
 ...
 * @return The value.
 */
const char *purple_account_get_string(const GaimAccount *account,
									const char *name,
 ...
 * @return The value.
 */
gboolean purple_account_get_bool(const GaimAccount *account, const char *name,
 ...
 * @return The value.
 */
int purple_account_get_ui_int(const GaimAccount *account, const char *ui,
 ...
 * @return The value.
 */
const char *purple_account_get_ui_string(const GaimAccount *account,
 ...
 * @return The value.
 */
gboolean purple_account_get_ui_bool(const GaimAccount *account, const char *ui,
 ...
 *       with appropriately.
 */
GaimLog *purple_account_get_log(GaimAccount *account, gboolean create);
 ...
 * @param account The account.
 */
void purple_account_destroy_log(GaimAccount *account);
 ...
 */
void purple_account_add_buddy(GaimAccount *account, GaimBuddy *buddy);
/**
 ...
 */
void purple_account_add_buddies(GaimAccount *account, GList *buddies);
 ...
 */
void purple_account_remove_buddy(GaimAccount *account, GaimBuddy *buddy,
								GaimGroup *group);
 ...
 */
void purple_account_remove_buddies(GaimAccount *account, GList *buddies,
									GList *groups);
 ...
 */
void purple_account_remove_group(GaimAccount *account, GaimGroup *group);
 ...
 */
void purple_account_change_password(GaimAccount *account, const char *orig_pw,
									const char *new_pw);
 ...
 */
gboolean purple_account_supports_offline_message(GaimAccount *account, GaimBuddy *buddy);
 ...
 * @param account The account.
 */
void purple_accounts_add(GaimAccount *account);
 ...
 * @param account The account.
 */
void purple_accounts_remove(GaimAccount *account);
 ...
 * @param account The account.
 */
void purple_accounts_delete(GaimAccount *account);
 ...
 */
void purple_accounts_reorder(GaimAccount *account, gint new_index);
 ...
 */
GaimAccount *purple_accounts_find(const char *name, const char *protocol);
 ...
 */
void purple_accounts_set_ui_ops(GaimAccountUiOps *ops);
 ...
 */
GaimAccountUiOps *purple_accounts_get_ui_ops(void);
