// _PasswordPrompt_EOArchive_pl.java
// Generated by EnterpriseObjects palette at niedziela, 27 listopada 2005 00:45:36 Europe/Warsaw
...
public class _PasswordPrompt_EOArchive_pl extends com.webobjects.eoapplication.EOArchive {
    ...
    public _PasswordPrompt_EOArchive_pl(Object owner, NSDisposableRegistry registry) {
    ...
    protected void _construct() {
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "imageView_service")) != null)) {
        ...
        _nsTextField2 = (com.webobjects.eointerface.swing.EOTextField)_registered(new com.webobjects.eointerface.swing.EOTextField(), "Field11");

        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "textField_account")) != null)) {
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "checkBox_savePassword.nextFocusableComponent.nextFocusableComponent")) != null)) {
            ...
            _nsButton1 = (javax.swing.JButton)_registered(new javax.swing.JButton("Poniechaj"), "NSButton1");
        }
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "checkBox_savePassword.nextFocusableComponent")) != null)) {
            ...
            _nsButton0 = (javax.swing.JButton)_registered(new javax.swing.JButton("Gotowe"), "NSButton");
        }
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "textField_account.nextFocusableComponent")) != null)) {
    ...
    protected void _awaken() {
        ...
        if (_replacedObjects.objectForKey("_nsImageView0") == null) {
            _connect(_owner(), _nsImageView0, "imageView_service");
        }
        ...
        if (_replacedObjects.objectForKey("_nsTextField1") == null) {
            _connect(_owner(), _nsTextField1, "textField_account");
        }

        if (_replacedObjects.objectForKey("_nsButton0") == null) {
            _connect(_owner(), _nsButton0, "button_OK");
        }
        ...
        _nsButton0.addActionListener((com.webobjects.eointerface.swing.EOControlActionAdapter)_registered(new com.webobjects.eointerface.swing.EOControlActionAdapter(_owner(), "okay", _nsButton0), ""));
    ...
    protected void _init() {
        ...
        _nsTextField2.setText("Podaj has\u0142o swojego konta.");
        ...
        _connect(_nsTextField2, _nsTextField1, "nextFocusableComponent");

        if (_replacedObjects.objectForKey("_nsTextField1") == null) {
            _connect(_nsTextField1, _nsSecureTextField0, "nextFocusableComponent");
        }
        ...
        if (_replacedObjects.objectForKey("_nsTextField1") == null) {
            ...
            _nsTextField1.setEnabled(false);
        ...
        _nsTextField0.setSize(68, 17);
        _nsTextField0.setLocation(98, 62);
        ((EOViewLayout)_nsView0.getLayout()).setAutosizingMask(_nsTextField0, EOViewLayout.MinYMargin);
        _nsView0.add(_nsTextField0);
        _nsSecureTextField0.setSize(155, 21);
        _nsSecureTextField0.setLocation(171, 60);
        ...
        if (_replacedObjects.objectForKey("_eoFrame0") == null) {
            _nsView0.setSize(422, 154);
            _eoFrame0.setTitle("\u0141\u0105cz\u0119 si\u0119 z kontem");
            _eoFrame0.setLocation(285, 246);
            _eoFrame0.setSize(422, 154);
        }
    }
}
